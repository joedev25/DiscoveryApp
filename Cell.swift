...
class Cell: UICollectionViewCell {
    ...
    fileprivate func setup(){
        ...
        destImageView.widthAnchor.constraint(equalTo:  self.heightAnchor,multiplier: 0.7).isActive = true
        destImageView.heightAnchor.constraint(equalTo: self.heightAnchor,multiplier: 0.65).isActive = true
        
        labelsStack.centerXAnchor.constraint(equalTo: self.centerXAnchor).isActive = true
        labelsStack.topAnchor.constraint(equalTo: destImageView.bottomAnchor,constant: 20).isActive = true
        labelsStack.widthAnchor.constraint(equalTo:  self.heightAnchor,multiplier: 0.75).isActive = true
        labelsStack.bottomAnchor.constraint(equalTo: self.bottomAnchor,constant: -10).isActive = true
    }
}
